...
public class PredictionServiceTest {
    ...
    private PredictionService predictionService = new PredictionService(ImmutableList.of(leNet5Network, neuralNetwork), null);
    ...
    public void displayRealValue() throws Exception {
        ...
        System.out.println(neuralNetwork.classify(new Pixels(null, doubles, null)));
