...
public class PredictionServiceTest {
    ...
    private PredictionService predictionService = new PredictionService(neuralNetwork);
    ...
    public void displayRealValue() throws Exception {
        ...
        final double[] doubles = predictionService.readPixels(body);
        System.out.println(neuralNetwork.classify(doubles));
